...
public class RegisterUser extends AppCompatActivity implements View.OnClickListener {
    ...
    @Override
    //finds out what button is clicked
    ...
    //saves all info that user is registering with
    private void registerUser() {
        ...
        //creates a user and saves it to the user class and adds it to the firebase database
